...
export const meta = {
  ...
  section: 'technology'
  seoKeywords: 'kubernetes,argo,pipeline,helm,redis,bug,cloud-native,github actions',
  url: 'a-day-in-the-life-of-a-kubernetes-developer',
  logoUrl: 'https://logos-download.com/wp-content/uploads/2018/09/Kubernetes_Logo.png'
}
